...
The [cat] sat on the [mat]. It can display correct answers in dropdown lists by setting the 
showanswers option in the question edit form.

This question type was written by Marcus Green

This question type was created under Moodle 2.2 and tested with 2.3 It will not work with versions of 
moodle prior to 2.1.
