...
class qtype_gapfill_edit_form extends question_edit_form {
    ...
    protected function definition_inner($mform) {
        ...
        $mform->addElement('editor', 'correct', get_string('correct', 'qtype_gapfill'), array('size' => 70, 'rows' => 4),  ['autosave' => false]);
        $mform->addElement('editor', 'incorrect', get_string('incorrect', 'qtype_gapfill'), array('size' => 70, 'rows' => 4),  ['autosave' => false]);
