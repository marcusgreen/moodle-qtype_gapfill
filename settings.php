...
if (is_siteadmin()) {
    ...
    $settingspage->add(new admin_setting_configcheckbox('qtype_gapfill/buildermode',
        get_string('buildermode', 'qtype_gapfill'),
        get_string('buildermode_text', 'qtype_gapfill') , 0));
