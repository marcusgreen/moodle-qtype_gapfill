...
$string['description'] = 'This will import a set of sample quesitons in in a new category called Gapfill examples';
$string['importwarning'] = 'You appear to already have a Gapfill example question category, this import may produce duplicate questions';
$string['importlink'] = 'Import link';
$string['importlink_text'] = 'Show link for importing example questions';
